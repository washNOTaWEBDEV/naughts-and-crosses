...
play_again_rect = pygame.Rect(square_size + 10, square_size * 2 + 42, square_size * 3 - 20, square_size - 82)
...
def draw_gridlines():
    ...
    for i in range(2, 4):
        pygame.draw.line(
            screen, black_gridline, (square_size, square_size * i), (square_size * 4, square_size * (i)), line_width)
        pygame.draw.line(
            screen, black_gridline, (square_size * i, square_size), (square_size * i, square_size * 4), line_width)
...
def end_of_game():
    ...
    if winner == 0:
        ...
        winner == "circle" and switch_naughts_and_crosses == -1 or winner == "cross" and switch_naughts_and_crosses == 1):
    ...
    if not draw_data[0]:
        if winning_line_data_draw[0] == "row":
            pygame.draw.line(screen, color, (winning_line_data_draw[1] * square_size + square_size // 2 - 5, winning_line_data_draw[3] * square_size + square_size // 2),
            (winning_line_data_draw[2] * square_size + square_size // 2 + 5, winning_line_data_draw[3] * square_size + square_size // 2), thickness)
        elif winning_line_data_draw[0] == "column":
            pygame.draw.line(screen, color, (winning_line_data_draw[3] * square_size + square_size // 2, winning_line_data_draw[1] * square_size + square_size // 2),
            (winning_line_data_draw[3] * square_size + square_size // 2, winning_line_data_draw[2] * square_size + square_size // 2), thickness)
        elif winning_line_data_draw[0] == "diagonal":
            pygame.draw.line(screen, color, (winning_line_data_draw[2] * square_size + square_size // 2, winning_line_data_draw[1] * square_size + square_size // 2),
            (winning_line_data_draw[4] * square_size + square_size // 2, winning_line_data_draw[3] * square_size + square_size // 2), thickness)
